...
import { ssrRenderClass, ssrRenderComponent, ssrRenderAttrs } from 'vue/server-renderer';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SplashShader.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SplashShader = _sfc_main$1;
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_component_SplashShader, {
        ref_key: "splashRef",
        ref: splashRef,
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/shaderTry.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=shaderTry-C9BaLCx6.mjs.map
